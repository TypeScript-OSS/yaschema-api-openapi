import './internal/init/init-build-component-schema-if-needed-impl.js';

import type { OpenAPIV3_1 } from 'openapi-types';
import type { GenericHttpApi } from 'yaschema-api';

import { convertParameterizedUrlInfoToOpenApiServerObjectFormat } from './internal/utils/convert-parameterized-url-info-to-open-api-server-object-format.js';
import { makeOpenApiPathsAndComponentsForApis } from './internal/utils/make-open-api-paths-and-components-for-apis.js';
